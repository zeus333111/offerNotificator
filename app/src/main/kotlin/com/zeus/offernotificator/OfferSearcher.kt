...
class OfferSearcher {
    ...
    fun startDaemon() = runBlocking {
        while (true) {
            val doc = Jsoup.connect("https://www.cyberpuerta.mx/Computo-Hardware/Componentes/Tarjetas-de-Video/Tarjeta-de-Video-EVGA-NVIDIA-GeForce-RTX-3080-FTW3-ULTRA-Gaming-10GB-320-bit-GDDR6X-PCI-Express-x16-4-0.html").get()
            ...
            button.forEach {
                println(it.toString())
                notificator.sendNotification("Disponible")
            }
